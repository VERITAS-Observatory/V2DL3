...
def cli(folder_location, index_file_dir,
    ...
    logging.info('Generating index files {}/obs-index.fits.gz and {}/hdu-index.fits.gz'
                 .format(index_file_dir, index_file_dir))
