...
def fill_response(datasource):
    ...
    if irfs_to_store['point-like']:
        ...
        hdu_ea.header.set('RAD_MAX ', response_dict['RAD_MAX'], 'Direction cut applied [deg]')
        ...
        # Fill Standard HDUCLASS keyword
        hdu_edisp = addHDUClassKeyword(hdu_edisp, class1='RESPONSE', class2='EDISP',
                                  class3='POINT-LIKE', class4='EDISP_2D')
        ...
        # hdu_ea.header.set('TUNIT5 ', 'm^2', "")

        # TH: I believe there is no 'LO_THRES' keyword within the energy dispersion IRF.
        # hdu_edisp.header.set('LO_THRES', response_dict['LO_THRES'],
        #                      'Low energy threshold of validity [TeV]')
        # hdu_edisp.header.set('HI_THRES', response_dict['HI_THRES'],
        #                      'High energy threshold of validity [TeV]')
        hdu_edisp.header.set('RAD_MAX ', response_dict['RAD_MAX'], 'Direction cut applied [deg]')
        #Axis order
    ...
    if irfs_to_store['full-enclosure']:
        ...
        hdu_fe_ea.header.set('HI_THRES', response_dict['HI_THRES'],
                             'High energy threshold of validity [TeV]')
        hdu_fe_ea.header.set('CREF5', '(ENERG_LO:ENERG_HI,THETA_LO:THETA_HI)', '')
        #
        ...
        hdu_fe_edisp.header.set('CREF7', '(ETRUE_LO:ETRUE_HI,MIGRA_LO:MIGRA_HI,THETA_LO:THETA_HI)', '')
        #
