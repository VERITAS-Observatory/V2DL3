...
def create_obs_hdu_index(data_path_list):
    ...
    **hdu-index.fits.gz**
    ...
    ----------
    data_path_list : list
        list of paths to the DL3 .fits files, paths relative to the scripts folder
    ...
    for _file in data_path_list:
        _filename = _file.split('/')[-1]
        _path = _file.split('/')[-3] + '/' + _file.split('/')[-2]
        # open the fits file
    ...
    # create the obs-index.fits.gz file
    ...
    # log.info(f'Writing f{filename}')
    obs_table.write(filename, overwrite=True)


def main():
    create_obs_hdu_index([
        'data/magic/run05029747_05029748/run05029747/20131004_05029747_CrabNebula.fits',
        'data/magic/run05029747_05029748/run05029748/20131004_05029748_CrabNebula.fits',
    ])
